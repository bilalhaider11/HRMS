...
Revision ID: ab90c9ae2109
Revises: 
Create Date: 2026-04-03 09:43:11.066407
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_additional_roles_id'), 'additional_roles', ['id'], unique=False)
