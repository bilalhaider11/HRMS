...
const Modal = React.forwardRef<HTMLDivElement, ModalProps>(({
  ...
  return ReactDOM.createPortal (
    ...
    >
      <div
        ref={ref}
        className={`relative bg-slate-900 border border-slate-800 min-w-[300px] w-full max-w-[500px] rounded-2xl overflow-hidden transition-opacity duration-300 min-h-[200px] max-h-[85%] overflow-y-auto ${modalClassName}`}
      >
