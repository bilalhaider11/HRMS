...
const CategoryForm = () => {
    ...
    const { addCategory, clearError, idExistError, successfullModal, setSuccessfullModal, setEditingCategory, editingCategory, updateCategory, categoryList } = useInventory();
    ...
    const handleSubmit = (values: any) => {
        ...
        if (editingCategory !== null && updateCategory) {
            ...
            const added = addCategory(newStore);
            console.log(added)
            if (added) {
                formik.resetForm();
            }
    ...
    console.log(editingCategory, "editing store")
        ...
        <>
            ...
            {successfullModal &&
                <SuccessfullModal modalClassName="" modalMain="" successfullOk={successfullyAdded}>
                    {editingCategory ? 'Successfully Updated your Category.' : 'Successfully Registered your Category.'}
                </SuccessfullModal>
            }
        </>
    )
